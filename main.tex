...
%{\color{red} \huge Si no normalizas, lo que obtenés no es una transformación canónica.}
...
%\notamm{Tomás, mirando los resultados que están en la carpeta, me parece que vas a tener que revisar este capítulo.
%Fijate que en las simulaciones con bosones no puse estados completamente mezclados en ninguno de los subsistemas, porque justamente ahí nos estaríamos yendo muy lejos de la zona en que funciona la aproximación. El objetivo de este tipo de cálculos es \emph{entender} el régimen de validez de una aproximación, e identificar qué cosas van mal por violar una hipótesis, y qué cosas fallan por cuestiones numéricas o de implementación. Por ejemplo, muchos de los resultados sobre los que se basan las conclusiones que están escritas vienen de la amplificación de problemas de redondeo más que de la aproximación en sí. La otra cuestión que falla es que los resultados no parecen consistentes con la teoría que usaste para obtenerlos: Por ejemplo, que sistemáticamente los resultados de MaxEnt de 1 cuerpo den mejor que los de MaxEnt de 2 cuerpos, espacio que contiene al primero, parece dar más cuenta de una falla en la implementación de la simulación o de una falla en el algoritmo de optimización que una característica del método de aproximación en sí. Seguramente, los jurados van a hacer hincapié en críticas similares, pero sobre todo, cuando querramos publicar estos resultados, una discusión así no pasaría ninguna instancia de referato.
%Por esto, en lo que queda de la semana, la prioridad es terminar de hacer las simulaciones y volver a escribir este capítulo.
%}
...
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.75]{figs/section3_4/section5_bxb-closed-nonres/b5xb10_c_nonres_g.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.75]{figs/section3_4/section5_bxb-closed-nonres/b10xb5_c_nonres_g.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.75]{figs/section3_4/section5_bxb-closed-nonres/b15xb15_c_nonres_g.png}}
...
\begin{figure}
    \centering
    \subfloat[\centering ]{{\includegraphics[scale=0.55]{figs/section3_4/section5_bxb-closed-nonres/n1_ocupation_number_closed_nonres_g.jpeg} }}
    \qquad
    \subfloat[\centering ]{{\includegraphics[scale=0.55]{figs/section3_4/section5_bxb-closed-nonres/n2_ocupation_number_closed_nonres_g.jpeg}}}
...
%Estos resultados demuestran la aplicabilidad de estas rutinas en la descripción aproximada de esta rutina puediendo modelar al estado exacto del sistema por aquel obtenido mediante Proyección Ortogonal de forma más eficiente y consumiendo menos recursos informáticos que con Max-Ent, sin perder demasiada exactitud en los resultados. 
Por tanto, los estados obtenidos mediante estas rutinas son poco distinguibles del estado exacto del sistema. 

\begin{figure}
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.72]{figs/section3_4/section5_bxb-closed-res/b5xb10_c_res_g.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.72]{figs/section3_4/section5_bxb-closed-res/b10xb5_c_res_g.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.72]{figs/section3_4/section5_bxb-closed-res/b20xb20_c_res_g.png}}
...
\begin{figure}
    \centering
    \subfloat[\centering ]{{\includegraphics[scale=0.2]{figs/section3_4/section5_bxb-closed-res/n1_ocupation_number_closed_res_g.jpg}}}
    \qquad
    \subfloat[\centering ]{{\includegraphics[scale=0.2]{figs/section3_4/section5_bxb-closed-res/n2_ocupation_number_closed_res_g.jpg}}}
...
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.75]{figs/section3_4/section5_bxb-open-nonres/b5xb10_open_nonres_g.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.75]{figs/section3_4/section5_bxb-open-nonres/b10xb5_open_nonres_g.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.75]{figs/section3_4/section5_bxb-open-nonres/b15xb15_open_nonres_g.png}}
...
%\notamm{Tom: fijate que en las simulaciones (al menos las que hice yo) la temperatura del segundo sistema también es finita. Vos lo cambiaste a eso? 
%
%Nono, la temperatura del segundo sistema es finita y seteada a 1.0 si mal no recuerdo. }
...
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.75]{figs/section3_4/section5_bxb_low-closed_nonres/b5xb10_nonres_ng.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.75]{figs/section3_4/section5_bxb_low-closed_nonres/b10xb5_nonres_ng.png}}
\end{minipage}\par\medskip
\centering
...
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:a}\includegraphics[scale=.75]{figs/section3_4/section5_bxs-open-nonres/b10xs_nonres_g.png}}
\end{minipage}%
\begin{minipage}{.5\linewidth}
\centering
\subfloat[]{\label{main:b}\includegraphics[scale=.75]{figs/section3_4/section5_bxs-open-nonres/b20xs_nonres_g.png}}
\end{minipage}\par\medskip
\centering
\subfloat[]{\label{main:c}\includegraphics[scale=.75]{figs/section3_4/section5_bxs-open-nonres/b30xs_nonres_g.png}}
